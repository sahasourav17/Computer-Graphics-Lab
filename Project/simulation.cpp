...
void screen1(){
    ...
    char str1[]="DEPARTMENT  OF  COMPUTER  SCIENCE  AND  ENGINEERING,CUET";
    drawstring(str1,-0.9,0.9,0.0);
    glColor3f(0.9,0.9,0.9);
    char str2[]="Course Title: Computer Graphics(Sessional)";
    drawstring(str2,-0.5,0.8,0.0);
    glColor3f(0.8,0.8,0.8);
    char str3[]="Course Code: CSE-438 ";
    drawstring(str3,-0.3,0.7,0.0);
    glColor3f(1.0,0.7,0.7);
    char str4[]="-*- A  MINI PROJECT ON VERTICAL LIFT BRIDGE SIMULATION  -*-";
    drawstring(str4,-0.85,0.6,0.0);
    glColor3f(0.2,0.8,0.5);
    char str5[]="Submitted by :";
    drawstring(str5,-0.5,0.5,0.0);
    glColor3f(1.0,1.0,0.0);
    char str6[]="            Jawad Bin Anwar (1704091)";
    drawstring(str6,-0.5,0.4,0.0);
    char str7[]="                Sourav Saha (1704093)";
    drawstring(str7,-0.5,0.3,0.0);
    glColor3f(0.2,0.8,0.5);
    char str8[]="Submitted to  :";
    drawstring(str8,-0.5,0.1,0.0);
    glColor3f(1.0,1.0,0.0);
    char str9[]="            Md. Mynul Hasan";
    drawstring(str9,-0.5,0.0,0.0);
    char str10[]="    Asst.prof. Dept of CSE,CUET)";
...
int main(int argc,char **argv){
    ...
    glutCreateWindow("Vertical Lift Bridge Simulation");
